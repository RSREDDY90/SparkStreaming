...
class ScalaConsumerExample(val zookeeper: String, val groupId: String, val topic: String, val delay: Long) extends Logging {
...
object ScalaConsumerExample extends App {
  ...
  //val zookeeper: String, val groupId: String, val topic: String, val delay: Long
  val example = new ScalaConsumerExample("localhost:2181", "test-consumer-group", "test",60)
  example.run(2)
}
